...
void OnTick()
{
   ...
   bool buySignal = (ma1 > ma2 && rsi < 30 && macd_main > macd_signal);
   bool sellSignal = (ma1 < ma2 && rsi > 70 && macd_main < macd_signal);
   ...
   for (int i = OrdersTotal() - 1; i >= 0; i--)
   {
      ...
      {
         if (OrderType() == OP_BUY && (ma1 < ma2 || macd_main < macd_signal))
         {
         ...
         else if (OrderType() == OP_SELL && (ma1 > ma2 || macd_main > macd_signal))
         {
